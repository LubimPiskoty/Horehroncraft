...
public class ModConfiguredStructures {
    ...
    public static StructureFeature<?, ?> CONFIGURED_CHATRC = ModStructures.CHATRC.get()
     ...
     * on and made.
     * But the best time to register configured features by code is honestly to do
     * it in FMLCommonSetupEvent.
     */
    public static void registerConfiguredStructures() {
        Registry<StructureFeature<?, ?>> registry = WorldGenRegistries.CONFIGURED_STRUCTURE_FEATURE;

        Registry.register(registry, new ResourceLocation(HorehronCraft.MOD_ID, "configured_chatrc"),
                CONFIGURED_CHATRC);
         ...
         * If they use
         * FlatGenerationSettings.STRUCTURE_FEATURES in it and you don't add your
         * structure to it, the game
         * could crash later when you attempt to add the StructureSeparationSettings to
         * the dimension.
         *
         ...
         * FlatChunkGenerator check
         * in StructureTutorialMain.addDimensionalSpacing and then create a superflat
         * world, exit it,
         * and re-enter it and your structures will be spawning. I could not figure out
         * why it needs
         * the restart but honestly, superflat is really buggy and shouldn't be your
         * main focus in my opinion.
         *

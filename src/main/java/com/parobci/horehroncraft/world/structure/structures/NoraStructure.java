...
public class NoraStructure extends Structure<NoFeatureConfig> {
    public NoraStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return NoraStructure.Start::new;
    }
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed,
        ...
        for (Biome biome1 : biomeSource.getBiomesWithin(chunkX * 16 + 9, chunkGenerator.getSeaLevel(), chunkZ * 16 + 9,
                29)) {
            if (biome1.getBiomeCategory() != Biome.Category.TAIGA
                    && biome1.getBiomeCategory() != Biome.Category.EXTREME_HILLS
                    && biome1.getBiomeCategory() != Biome.Category.SWAMP) {
                return false;
            }
        }
        ...
        return topBlock.getFluidState().isEmpty();// && ModStructures.CHATRC_BIOMES.contains(biome.toString()); // landHeight > 100;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            // pools.
                            .get(new ResourceLocation(HorehronCraft.MOD_ID, "nora/start_pool")),
